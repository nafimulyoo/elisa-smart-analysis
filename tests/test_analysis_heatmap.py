...
def test_get_heatmap_analysis_current_range(test_client):
    ...
    time_and_print(test_client, url, "test_get_heatmap_analysis_valid_range")
...
def test_get_heatmap_analysis_past_dates(test_client):
    ...
    time_and_print(test_client, url, "test_get_heatmap_analysis_past_dates")
...
def test_get_heatmap_analysis_past_dates_faculty(test_client):
    ...
    time_and_print(test_client, url, "test_get_heatmap_analysis_past_dates_faculty")

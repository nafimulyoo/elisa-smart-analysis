...
def test_get_monthly_analysis_current_month(test_client):
    ...
    time_and_print(test_client, url, "test_get_monthly_analysis_current_month")
...
def test_get_monthly_analysis_past_month(test_client):
    ...
    time_and_print(test_client, url, "test_get_monthly_analysis_past_month")
...
def test_get_monthly_analysis_past_faculty(test_client):
    ...
    time_and_print(test_client, url, "test_get_monthly_analysis_past_month_faculty")

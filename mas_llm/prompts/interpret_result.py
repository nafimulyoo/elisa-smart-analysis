INTERPRET_RESULT_WEB_PROMPT: str = """
    ...
    - explanation: A clear and concise 3-4 sentence of explanation of the analysis result (e.g., trends, insights, or observations). Use the same language as the user's question. Always provide units in the explanation, e.g., "kWh", "kW", "Rp", "Grafik garis menunjukkan perbandingan penggunaan energi per jam (kWh) antara Labtek VI dan FTI selama seminggu terakhir..
